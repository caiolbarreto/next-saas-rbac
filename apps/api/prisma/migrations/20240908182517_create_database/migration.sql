...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_organization?id_fkey" FOREIGN KEY ("organization?id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
