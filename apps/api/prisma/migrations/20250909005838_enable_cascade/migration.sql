...
-- DropForeignKey
ALTER TABLE "projects" DROP CONSTRAINT "projects_organization?id_fkey";
...
-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_organization?id_fkey" FOREIGN KEY ("organization?id") REFERENCES "organizations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
